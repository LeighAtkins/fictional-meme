  ...
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "url": "https://leighatkins.dev",
              "image": "https://leighatkins.dev/og-image.jpg",
              "sameAs": [
                "https://github.com/leighatkins",
                "https://linkedin.com/in/leighatkins",
                "https://twitter.com/leighatkins"
              ],
              "worksFor": {
                "@type": "Organization",
                "name": "Freelance"
      ...
      <div className="bg-gray-50 text-gray-900 font-sans">
        ...
        <nav id="navbar" className="bg-white shadow-sm fixed w-full top-0 z-50 transition-all duration-300">
            ...
            <div className="flex justify-between items-center py-4">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-8">
                  <button 
                    onClick={() => scrollToSection('hero')}
                    className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium transition duration-300 relative group"
                  >
                    Home
        ...
        <main>
              ...
              <div className="animate-fade-in">
                ...
                <div className="mb-8 flex justify-center">
                  <div className="relative">
                    <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center shadow-2xl ring-4 ring-white ring-opacity-50">
                ...
                <div className="mb-8">
                  ...
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 mb-4">
          ...
          {/* Enhanced Projects Portfolio Showcase */}
                  ...
                  <div className="space-y-6 mb-8">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">hello@leighatkins.dev</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800">Response Time</h4>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-10 h-10 bg-gray-800 text-white rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors duration-300"
                      >
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="w-10 h-10 bg-blue-400 text-white rounded-lg flex items-center justify-center hover:bg-blue-500 transition-colors duration-300"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
